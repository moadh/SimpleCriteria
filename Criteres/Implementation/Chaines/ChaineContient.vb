Public Class ChaineContient(Of T As IElementFiltrable)
...
#Region "Prédicat"
    ...
    Private Function EstValidePour(valeurElement As Object) As Boolean
        Return valeurElement.ToString.ToLower.Contains(_Valeur.ToLower)
    End Function
#End Region
...
#Region "Arguments"
    ...
    Protected Overrides Function IsArgumentsInvalid(ParamArray args() As Object) As Boolean
        _NbArguments = 1
        _ArgumentsInvalidExceptionMessage = "pour le critère ChaineContient il faut définir une chaine non nulle comme argument"
