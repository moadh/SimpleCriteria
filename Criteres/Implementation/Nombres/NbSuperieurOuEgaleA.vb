Public Class NbSuperieurOuEgaleA(Of T As IElementFiltrable)
...
#Region "Prédicat"
    Public Overrides Function Accept(element As T) As Boolean
        If IsNothing(_GetElementValeur) Then Throw New NoNullAllowedException("Pour un critère de type supérieur à, il faut spécifié la méthode GetValeur")
