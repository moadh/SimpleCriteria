Public Class DateEgaleA(Of T As IElementFiltrable)
...
#Region "Arguments"
    ...
    Protected Overrides Function IsArgumentsInvalid(ParamArray args() As Object) As Boolean
        _NbArguments = 1
        _ArgumentsInvalidExceptionMessage = "pour le critère DateEgaleA il faut définir une date non nulle comme argument"
