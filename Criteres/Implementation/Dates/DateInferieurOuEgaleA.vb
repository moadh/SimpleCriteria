Public Class DateInferieurOuEgaleA(Of T As IElementFiltrable)
...
#Region "Arguments"
    ...
    Protected Overrides Function IsArgumentsInvalid(ParamArray args() As Object) As Boolean
        _NbArguments = 1
        _ArgumentsInvalidExceptionMessage = "pour le critère DateInferieurA il faut définir une date non nulle comme argument"
